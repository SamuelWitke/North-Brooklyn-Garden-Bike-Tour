...
import third from '../img/journey/3.jpg';
export default () => (
  <section className="js-section" data-zoom-start="1.2">
    <h2>
      <span className="title-up">301 Berry St, Brooklyn, NY 11211</span>
      <span className="title-down">Berry Street Garden</span>
    </h2>
    <p>

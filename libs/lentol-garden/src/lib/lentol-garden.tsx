import './lentol-garden.module.css';

/* eslint-disable-next-line */
export interface LentolGardenProps {}

export function LentolGarden(props: LentolGardenProps) {
  return (
    ...
    <figure>
      <img className="js-image" data-pos="0.6" alt="Fifth Pic" />
      <figcaption>

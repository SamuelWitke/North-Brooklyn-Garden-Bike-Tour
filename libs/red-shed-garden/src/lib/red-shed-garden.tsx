import './red-shed-garden.module.css';

/* eslint-disable-next-line */
export interface RedShedGardenProps {}

export function RedShedGarden(props: RedShedGardenProps) {
  return (
